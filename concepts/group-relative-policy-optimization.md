...
See also: [Smaller Models are Natural Explorers for Policy-Level Diversity in GRPO](../papers/s2l-po.md), [Context-Aware RL for Agentic and Multimodal LLMs](../papers/contextrl.md), [BashCoder-R1: Towards Robust and Explainable Bash Code Generation with Robustness-Aware Group Relative Policy Optimization](../papers/bashcoder-r1.md), [Qwen-Image-2.0-RL Technical Report](../papers/qwen-image-2-0-rl.md), [LLM-as-a-Verifier: A General-Purpose Verification Framework](../papers/llm-as-a-verifier.md), [Is One Layer Enough? Training A Single Transformer Layer Can Match Full-Parameter RL Training](../papers/is-one-layer-enough-rl-training.md)
