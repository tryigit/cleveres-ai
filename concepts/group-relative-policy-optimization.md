...
See also: [Smaller Models are Natural Explorers for Policy-Level Diversity in GRPO](../papers/s2l-po.md), [Context-Aware RL for Agentic and Multimodal LLMs](../papers/contextrl.md), [BashCoder-R1: Towards Robust and Explainable Bash Code Generation with Robustness-Aware Group Relative Policy Optimization](../papers/bashcoder-r1.md), [Qwen-Image-2.0-RL Technical Report](../papers/qwen-image-2-0-rl.md), [LLM-as-a-Verifier: A General-Purpose Verification Framework](../papers/llm-as-a-verifier.md), [Is One Layer Enough? Training A Single Transformer Layer Can Match Full-Parameter RL Training](../papers/is-one-layer-enough-rl-training.md), [LongStraw: Long-Context RL Beyond 2M Tokens under a Fixed GPU Budget](../papers/longstraw-long-context-rl.md), [Spectral Rewiring for Exploration, Purification, and Model Merging](../papers/spectral-rewiring-exploration-purification.md), [Beyond Euclidean Clipping: Overcoming Exploration Collapse in LLM RL via Riemannian Isometric Policy Optimization](../papers/ripo-riemannian-isometric-policy-optimization.md), [CoRT: Counterfactual Replay for Token-Level Rubric-Guided Policy Optimization](../papers/cort.md), [SkillRise: Agentic Reinforcement Learning for Cross-Task Skill Evolution](../papers/skillrise.md), [Distill Where You Fail: Recovering Learning Signals of Negative RL-Groups from Adaptive Teacher Guidance](../papers/rstg-adaptive-teacher-guidance.md), [Agent Lightning v1.0: Towards Harnessed Agentic RL](../papers/agent-lightning.md), [Annotations as Rollouts: Efficient and Scalable Reinforcement Learning for Video MLLMs](../papers/orarl-annotations-as-rollouts.md), [SimLoss: Single-Pass Fine-Grained Image Captioning](../papers/simloss-image-captioning.md), [DRACO: Fine-Grained Credit Assignment with Dynamic Rubrics for Long-Horizon Agent Training](../papers/draco-dynamic-rubrics-credit.md), [Locked at the Entrance, Open Inside: Where RLVR Narrows the Solution Space](../papers/locked-entrance-rlvr.md), [Verify Before You Distill: Prompt-Level Teacher Gating for On-Policy Distillation](../papers/verify-before-you-distill.md)
