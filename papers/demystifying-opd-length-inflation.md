...
See also: [PRISM: Pre-alignment via Black-box On-policy Distillation for Multimodal Reinforcement Learning](prism-pre-alignment.md), [Multi-Turn On-Policy Distillation with Prefix Replay](multi-turn-on-policy-distillation-prefix-replay.md), [Negative Self-Distillation: Learning to Reason by Avoiding Flaws](negative-self-distillation.md)
