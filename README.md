...
*   [DoRA: Weight-Decomposed Low-Rank Adaptation](papers/dora-weight-decomposed-low-rank-adaptation.md) - *A parameter-efficient fine-tuning method that decouples magnitude and direction updates.*
